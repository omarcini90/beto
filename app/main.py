...
def webhook_whatsapp():
    ...
    if mensaje is not None:
      ...
      mydb = mysql.connector.connect(
          host = "mysql-beto.alwaysdata.net",
          user = "beto",
          password = "20RosO99$",
          database='beto_chat'
      )
...
def enviar(telefonoRecibe,respuesta):
  ...
  token='EAAOHsA1dTT8BOyniYya6UoYvIJam22MbsxC3Ki7skP2ecNBGVyiZCFIHZBdykZCgbZCdSBXS6rmWpffXIq54YXBpyoZCXlSQDdioeIqdlL54aoh9OTKUZCZAift54pouc5ssvLfDwZBuXjVLE2ZARl4TJshpD7QYagZBurs9GQv6tsaaDNugHpcEahTBC5Ntuzge4MLA1vXeE18yuNkH2NWywZD'
  #IDENTIFICADOR DE NÚMERO DE TELÉFONO
  idNumeroTeléfono='114708041680036'
